...
public class Exercicio5 {
    // Média de peso por mercadoria, comercializadas no Brasil, separadas de acordo com o ano
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        j.setMapperClass(MapEx5.class);
        j.setReducerClass(ReduceEx5.class);
    ...
    public static class MapEx5 extends Mapper<LongWritable, Text, Text, FloatWritable> {
        // função de map
        public void map(LongWritable key, Text value, Context con) throws IOException, InterruptedException {
            ...
            // buscando transações comercializadas no Brasil
    ...
    public static class ReduceEx5 extends Reducer<Text, FloatWritable, Text, FloatWritable>{
